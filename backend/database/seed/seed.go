...
func Seed(db *sql.DB) {
	queries := []string{
		...
		(1, "Suatu ruangan memiliki suhu -6 derajat Celcius. Sore harinya, suhu diturunkan 22 derajat Celcius. Pagi hari keesokannya, suhu ruangan dinaikkan kembali 18 derajat Celcius. Berapa suhu ruangan di pagi tersebut?", "-10"),
		...
		(2, "Hasil panen kakek selama 5 bulan dalam ton adalah 10, 6, 7, 9, 8. Rata-rata hasil panen kakek tiap bulan adalah ... ton", "8"),
		(2, "Nilai median dari 10, 6, 7, 9, 8 adalah ...", "8"),
		...
		(2, "Nilai ulangan IPA Ani adalah 6, 6, 7, 8, 9, 8, 6, 7. Modus nilai ulangan IPA Ani adalah ...", "6"),
		...
		(3, "Tentukan FPB dari 50, 60, dan 75!", "5"),
