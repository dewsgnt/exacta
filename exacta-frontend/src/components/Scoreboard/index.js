...
const Board = () => {
  ...
  return (
    <section id='course' className="board flex flex-col items-center py-[10vh] h-full bg-[#EFEFEF]">
      ...
      <h2 className="text-2xl pb-[5vh] w-[70%] text-black">Silahkan pilih salah satu kategori di bawah ini untuk melihat papan skor</h2>
        ...
        <div className="flex flex-col items-center ">
          <table class="table-fixed">
            ...
            <tbody>
              {
                scoresBoard && scoresBoard.sort((a, b) => {
                  ...
                  return (
                    <tr className="bg-white">
                      ...
                      <td className="border border-slate-300 text-2xl py-[0.7vh] px-[8vw]">{durations[0] + ":" + durations[1]}
                      </td>
                    </tr>
                    )
                  }
